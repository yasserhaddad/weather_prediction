...
def bn_update(loader, model, batch_size, constants_expanded, device, verbose=False, **kwargs):
    """
    ...
    with torch.no_grad():
        ...
        for i in range(0, n_samples - batch_size, batch_size):
            ...
            input, _ = loader[idxs[i:i_next]]
            input = torch.cat((input[0][:batch_size, :, :], \
                                        constants_expanded, input[0][batch_size:, :, :], constants_expanded), dim=2).to(
                        device)
